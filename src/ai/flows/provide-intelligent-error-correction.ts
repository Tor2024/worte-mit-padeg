...
const prompt = ai.definePrompt({
  ...
  - Если ответ неправильный:
    ...
    2.  Кратко объясните, в чем ошибка. Например, если это форма Perfekt, обратите внимание на правильный вспомогательный глагол (haben/sein) или на форму Partizip II.
